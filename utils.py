...
class JointTransform2D:
    ...
    """
    def __init__(self, crop=(32, 32), p_flip=0.5, color_jitter_params=(0.3, 0.3, 0.3, 0.3),
    ...
    def __call__(self, image, mask):
        ...
        image = F.resize(image, [360, 360], interpolation=cv2.INTER_AREA)
        mask = F.resize(mask, [360, 360], interpolation=cv2.INTER_AREA)
...
class ImageToImage2D(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # cv2.imwrite('c500-test-label/' + image_filename[:-3] + 'png', mask2)
